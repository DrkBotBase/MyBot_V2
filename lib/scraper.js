...
async function styletext(teks) {
  try {
    let res = await axios.get('http://qaz.wtf/u/convert.cgi?text='+encodeURIComponent(teks))
    let $ = cheerio.load(res.data)
    let result = {}
...
module.exports = { y1s, expandUrl, pinterest, wallpaper, wikimedia, quotesAnime, aiovideodl, umma, ringtone, styletext, mediafireDl }
